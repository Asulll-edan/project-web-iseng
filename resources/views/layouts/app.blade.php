...
<head>
    ...
    <style>
        @font-face {
            font-family: 'INeedCoffee';
            src: url('/fonts/INeedCoffeeGlyphs.woff2') format('woff2');
            font-display: swap;
        }

        @font-face {
            font-family: 'Quesha';
            src: url('/fonts/Quesha.woff2') format('woff2');
            font-display: swap;
        }

        @font-face {
            font-family: 'BlackCoffee';
            src: url('/fonts/BlackCoffeeRegular-Bold.woff2') format('woff2');
            font-display: swap;
        }
        @font-face {
    font-family: 'Cafetalk';
    src: url('/fonts/CafetalkRegular.woff2') format('woff2');
    font-display: swap;
}
...
--font-body: 'Cafetalk', sans-serif;
--font-display: 'INeedCoffee', serif;
--font-menu:    'Cafetalk', sans-serif;
        }
    ...
    letter-spacing: 0.03em; 
        ...
        .btn-primary {
            ...
            box-shadow: 0 4px 20px rgba(90, 124, 101, .3)
        }

        .btn-primary:hover {
            background: var(--sage-dark);
            transform: translateY(-2px);
            box-shadow: 0 8px 30px rgba(90, 124, 101, .4)
        }
...
<body>
    ...
    <script>
        ...
        function showToast(msg, type = 'info', duration = 3500) {
            ...
            t.innerHTML =
                `<i class="ti ${icons[type]||'ti-bell'}" style="font-size:18px;flex-shrink:0"></i><span>${msg}</span>`;
